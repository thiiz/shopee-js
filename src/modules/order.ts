...
export class OrderModule {
	...
	async getOrderDetails(
		...
		if (
			...
			options.responseOptionalFields.length > 0
		) {
	...
	async cancelOrder(
		...
		await this.httpClient.post(API_PATHS.CANCEL_ORDER, body, {
			apiType: "shop",
			shopId,
			accessToken,
		});
	...
	async handleBuyerCancellation(
		...
		await this.httpClient.post(API_PATHS.HANDLE_BUYER_CANCELLATION, body, {
			apiType: "shop",
			shopId,
			accessToken,
		});
	...
	async splitOrder(
		...
		await this.httpClient.post(API_PATHS.SPLIT_ORDER, body, {
			apiType: "shop",
			shopId,
			accessToken,
		});
	...
	async unsplitOrder(
		...
		await this.httpClient.post(API_PATHS.UNSPLIT_ORDER, body, {
			apiType: "shop",
			shopId,
			accessToken,
		});
	...
	async getPackageDetail(
		...
		return this.httpClient.get(API_PATHS.GET_PACKAGE_DETAIL, params, {
			apiType: "shop",
			shopId,
			accessToken,
		});
