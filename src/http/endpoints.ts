...
export const API_PATHS = {
  ...
  GET_SHIPPING_DOCUMENT_PARAMETER: '/api/v2/logistics/get_shipping_document_parameter',
  ...
  GET_SHIPPING_DOCUMENT_DATA_INFO: '/api/v2/logistics/get_shipping_document_data_info',
