...
export class TokenManager {
   ...
   */
  async refreshShopToken(shopId: number, refreshToken: string): Promise<RefreshAccessTokenResponse> {
    const body = {
      shop_id: shopId,
   ...
   * @returns The raw response from Shopee API. Update your database with the new tokens.
   */
  async refreshMerchantToken(merchantId: number, refreshToken: string): Promise<RefreshAccessTokenResponse> {
    const body = {
